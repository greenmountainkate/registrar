...
public class CourseRecordIOTest {
	...
	/** Course records with errors */
	private String errorFile = "test-files/error_course_records.txt";
	...
	/**
	 * Tests whether CourseRecordIO can be instantiated.
	 */
	@Test
	public void testCourseRecordIO() {
		try {
			CourseRecordIO cr = new CourseRecordIO();
			assertTrue(cr instanceof CourseRecordIO);
	...
	/**
	 * Tests readCourseRecords from a non-existent file
	 *  
	 */
	@Test
	public void testReadFromInvalidFile() {
		...
		try {
			courses = CourseRecordIO.readCourseRecords("Not a file");
			fail();
		} catch (FileNotFoundException e) {
	...
	/**
	 * Tests readCourseRecords() ability to skip over lines of non course record
	 * content
	 * 
	 */
	@Test
	public void testReadCourseRecords() {
		...
		// Tests using a file with alphanumeric non Course record data
		try {
			courses = CourseRecordIO.readCourseRecords(errorFile);
	...
	/**
	 * Tests the writeCourseRecords() method of CourseRecordIO
	 * 
	 * 
	 * @throws IllegalArgumentException if Course is invalid format
	 */
	@Test
	public void testWriteCourseRecords() throws IllegalArgumentException {
	...
	/**
	 * Resets info in RegistrationManager
	 */
	@After
