...
public class CourseTest {
	...
	public void testSetTitle() {
		...
		// Test that setting the title to null doesn't change the title (or
		// anything else).
		try {
			c.setTitle(null);
			fail();
		...
		// Test that setting the title to "" doesn't change the title (or
		// anything else).
		try {
			c.setTitle("");
			fail();
	...
	public void testSetSection() {
		...
		// Test that setting the section to null doesn't change the section (or
		// anything else).
		try {
			c.setSection(null);
			fail();
		...
		// Test that setting the section to "" doesn't change the section (or
		// anything else).
		try {
			c.setSection("");
			fail();
		...
		// Test that setting the section to "00" doesn't change the section (or
		// anything else).
		try {
			c.setSection("00");
			fail();
		...
		// Test that setting the section to "0012" doesn't change the section
		// (or anything else).
		try {
			c.setSection("0012");
			fail();
		...
		// Test that setting the section to "app" doesn't change the section (or
		// anything else).
		try {
			c.setSection("app");
			fail();
	...
	public void testSetCredits() {
		...
		// Test that setting the credits to 0 doesn't change the credits (or
		// anything else).
		try {
			c.setCredits(0);
			fail();
		...
		// Test that setting the credits to 6 doesn't change the credits (or
		// anything else).
		try {
			c.setCredits(6);
			fail();
...
//		// Test that setting the instructor id to null doesn't change the
//		// instructor id (or anything else).
//		try {
...
//		}
		...
		// Test that setting the instructor id to "" doesn't change the
		// instructor id (or anything else).
		try {
			c.setInstructorId("");
			fail();
	...
	public void testSetMeetingDays() {
		...
		// Test that setting the meeting days to null doesn't change the meeting
		...
		// Test that setting the meeting days to "" doesn't change the meeting
		// days (or anything else).
		try {
			c.setMeetingDays("");
			fail();
		...
		// Test that setting the meeting days with an invalid character doesn't
		// change the meeting days (or anything else).
		try {
		...
		// Test that setting the meeting days more than one character other than
		// 'A' doesn't change the meeting days (or anything else).
		try {
			c.setMeetingDays("MA");
			fail();
		} catch (IllegalArgumentException e) {
		...
		// Test that setting the meeting days to "MMF" doesn't change meeting
		// days or anything else
		try {
			c.setMeetingDays("MMF");
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
		...
		// Test that setting the meeting days to "TTH" doesn't change meeting
		// days or anything else
		try {
			c.setMeetingDays("TTH");
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
		...
		// Test that setting the meeting days to "MWWF" doesn't change meeting
		// days or anything else
		try {
			c.setMeetingDays("MWWF");
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
		...
		// Test that setting the meeting days to "THH" doesn't change meeting
		// days or anything else
		try {
			c.setMeetingDays("THH");
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
		...
		// Test that setting the meeting days to "MWFF" doesn't change meeting
		// days or anything else
		try {
			c.setMeetingDays("MWFF");
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
	...
	public void testSetCourseTime() {
		// The code below is commented out until you make some changes to
		// Course.
		...
		// Test that setting the start time to 2400 doesn't change the start
		...
		// Test that setting the start time to 1360 doesn't change the start
		// time (or anything else).
		try {
		...
		// Test that setting the start time to -1 doesn't change the start time
		// (or anything else).
		try {
		...
		// Test that having the start time after the end time doesn't change the
		// values.
		try {
	...
	public void testEqualsObject() {
		...
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				1400);
		Activity c10 = new Course("CSC230", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS,
				START_TIME, END_TIME);
		...
		Course c11 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		Object o = new Object();
		assertFalse(c11.equals(o));
	}
	...
	public void testToString() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,150,MW,1330,1445";
		assertEquals(s1, c1.toString());

		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, "A");
		String s2 = "CSC216,Programming Concepts - Java,001,4,sesmith5,150,A";
		assertEquals(s2, c2.toString());
	}

	/**
	 * Tests the compareTo() method of the Course class
	 *
	 * 
	 */
	@Test
	public void testCompareTo() {
		...
		Course c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		Course c3 = new Course("CSC116", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS,
				START_TIME, END_TIME);
		Course c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);

		// Test that same Course returns 0
		assertEquals(0, c1.compareTo(c1));

		// Test that identical Courses return 0, in both directions
		assertEquals(0, c1.compareTo(c2));
		assertEquals(0, c2.compareTo(c1));

		// Test that a prior Course name returns a negative integer
		assertTrue(c3.compareTo(c1) < 0);
		// Test that a later Course name returns a positive integer
		assertTrue(c1.compareTo(c3) > 0);

		// Test that a prior Section returns a negative integer
		assertTrue(c1.compareTo(c4) < 0);
		// Test that a later Section returns a positive integer
		assertTrue(c4.compareTo(c1) > 0);
	}

	/**
	 * Tests the isDuplicate() method of the Course class
	 * 
	 * 
	 */
	@Test
	public void testIsDuplicate() {
		...
		// Test that the same course is a duplicate of itself
		assertTrue(c1.isDuplicate(c1));

		// Test that identical Courses are duplicates in both directions
		assertTrue(c1.isDuplicate(c2));
		assertTrue(c2.isDuplicate(c1));

		// Test that different classes aren't duplicates in both directions
		assertFalse(c1.isDuplicate(c3));
		assertFalse(c3.isDuplicate(c1));
