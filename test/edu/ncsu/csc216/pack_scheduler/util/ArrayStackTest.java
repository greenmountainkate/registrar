...
/**
 * Tests the methods of the ArrayStack
 * 
 * @author kmbrown
 * @param <E> Elements that the ArrayStack holds
 *
 */
public class ArrayStackTest<E> {
	...
	public void arrayStackTest() {
		// construct new ArrayStack
		ArrayStack<E> as = new ArrayStack<E>(25);
		assertTrue(as instanceof ArrayStack);
	}
	...
	public void testPush() {
		ArrayStack<String> as = new ArrayStack<String>(25);
		String a = "apple";
		String b = "banana";
		String c = "cantaloupe";
	...
	/**
	 * Tests adding elements to the stack
	 */
	@Test
	public void testPop() {
		ArrayStack<String> as = new ArrayStack<String>(25);
	...
	/**
	 * Tests whether the isEmpty method correctly identifies when the Stack is empty
	 */
	@Test
	...
	/**
	 * Tests the ability to retrieve the correct size of the ArrayStack
	 */
	@Test
	...
	/**
	 * Tests various valid and invalid sets and resets of the capacity of the ArrayStack
	 */
	@Test
	public void testSetCapacity() {
		ArrayStack<String> as = new ArrayStack<String>(25);
		ArrayStack<String> as1 = new ArrayStack<String>(25);
		ArrayStack<String> as2 = new ArrayStack<String>(25);
		String a = "apple";
		String b = "banana";
		String c = "cantaloupe";
		String d = "dragonfruit";
