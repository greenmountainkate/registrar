...
public class CourseCatalogPanel extends JPanel implements ActionListener {
	...
	/**
	 * {@link CourseCatalogTableModel} is the object underlying the
	...
	private class CourseCatalogTableModel extends AbstractTableModel {
		...
		/**
		 * Constructs the {@link CourseCatalogTableModel} by requesting the
		 * latest information from the RequirementTrackerModel.
		 */
		...
		/**
		 * Updates the given model with Course information from the
		 * {@link CourseCatalog}.
		 */
